	...
	return (
        ...
        `}
				...
				<div className="relative">
					...
					<span className="absolute right-2.5 top-1/2 -translate-y-1/2 text-slate-600 pointer-events-none text-[10px]">
						▾
					</span>
				</div>
				...
				<div className="relative">
					<select
						...
						disabled={loadingCat}
						className={selectCls + (loadingCat ? " opacity-60" : "")}
						style={{ minWidth: 140 }}
					>
						<option value="">
							{loadingCat ? "Memuat..." : "Semua Kategori"}
						</option>
						{categories.map((k) => (
