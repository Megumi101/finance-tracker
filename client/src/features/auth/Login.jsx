...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (form.email === 'demo@fintrack.id' && form.password === 'demo123') {
    ...
    <div className="min-h-screen bg-[#080C14] flex items-center justify-center p-6 relative">
      ...
      <div className="relative w-full max-w-[420px] bg-[#0C1120] border border-white/[0.07] rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="px-8 py-9">
          ...
          {/* Demo hint */}
          <div className="mb-5 flex items-center gap-3 bg-violet-600/[0.07] border border-violet-500/20 rounded-xl px-4 py-3">
            <span className="text-violet-400 text-[14px] flex-shrink-0">💡</span>
            <div>
              <p className="text-[11px] text-violet-300 font-medium">Akun Demo</p>
              <p className="text-[11px] text-slate-500 mt-0.5 font-mono">demo@fintrack.id / demo123</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button
              ...
              className={`
                ...
                py-3 rounded-xl font-semibold text-[14px] text-white mt-1
